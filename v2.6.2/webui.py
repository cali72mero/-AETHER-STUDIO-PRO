    ...
    return f"""
        <div class="aether-header-bar-inner">
            <div class="aether-brand-title-group">
                ...
                <span class="aether-studio-version">v2.6.2 NEXT-GEN</span>
...
title = 'Aether Diffusion Studio Pro 2.6.2 • Autonomous Neural AI'
            ...
            with gr.Row(visible=modules.config.default_image_prompt_checkbox) as image_input_panel:
                with gr.Tabs(selected=modules.config.default_selected_image_input_tab_id):
                    ...
                    with gr.Tab(label='Describe & Vision Studio', id='describe_tab') as describe_tab:
                        gr.Markdown("### 🔬 Precision Vision Studio & Reverse Prompting (100% Lokal)")
                        with gr.Row():
                            with gr.Column(scale=1):
                                ...
                                vision_analyze_btn = gr.Button(
                                    value='🔍 Bild detailliert analysieren (Lokal)',
                                    variant='primary',
                            ...
                            with gr.Column(scale=1):
                                ...
                                vision_result_prompt = gr.Textbox(
                                    label='Generierter SDXL-Prompt (aus gewählten Attributen)',
                                    placeholder='Hier erscheint der hochdetaillierte Prompt nach der Analyse...',
                                    lines=4,
                                    interactive=True
                                )
                                with gr.Row():
                                    vision_apply_replace_btn = gr.Button('✨ Als Haupt-Prompt übernehmen', variant='primary')
                                    vision_apply_append_btn = gr.Button('➕ An aktuellen Prompt anhängen')
...
- **Zielordner:** `{data['target_dir']}`
        ...
        def trigger_vision_analyze(img_input, mask_mode, selected_filters):
            if img_input is None:
                return {}, "", "⚠️ Bitte lade zuerst ein Bild hoch!", "*(Kein Bild ausgewählt)*"
            ...
            if not result.get("success"):
                ...
                return result, "", f"⚠️ Fehler: {err_msg}", f"*(Fehler: {err_msg})*"
            ...
            return result, filtered_prompt, status_msg, breakdown_md
        ...
        vision_analyze_btn.click(
            ...
            outputs=[vision_state_data, vision_result_prompt, vision_status_text, vision_breakdown_md],
            show_progress=True,
            queue=True
        )
