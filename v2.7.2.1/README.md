...
# 🌌 Aether Diffusion Studio Pro 2.7.2.1 (Beta)
...
[![Status: Beta](https://img.shields.io/badge/Status-Beta%20v2.7.2.1-yellow.svg)](#-community-feedback--bug-reports)
[![Release: v2.7.2.1](https://img.shields.io/badge/Release-v2.7.2.1-cyan.svg)](v2.7.2.1/)
...
> [!NOTE]
> This software is independently developed and maintained by a **single solo developer**. The software is currently in active **Beta phase (v2.7.2.1 Beta)**.
> 
...
## 🔄 Version Evolution: Fooocus ➔ v2.5 ➔ v2.6 ➔ v2.6.3 ➔ v2.7.0 ➔ v2.7.1 ➔ v2.7.2 ➔ v2.7.2.1

### 🆕 What's New in v2.7.2.1 (Current Release - Custom Performance & Freely Configurable Sampling Steps)
...
2. **🎛️ Dual Slider & Precise Numeric Input for Steps (1–200 Steps)**:
   - Configure any desired sampling step count between 1 and 200 (e.g. 15, 20, 25, 40, 50, 75, 100 steps) for fine-grained experiments or special checkpoint requirements.
   - Includes bidirectional live synchronization between the visual slider and the exact number input box.
3. **⚡ Seamless Diffusion Pipeline Execution**:
   - Accurately executes the custom step count across standard SDXL sampling pipelines while keeping all other fine-tuned hyperparameters (CFG, refiners, LoRAs) intact.
...
| Feature | Standard Fooocus (v2.5) | Aether Studio Pro (v2.6) | Aether Studio Pro (v2.6.3) | 🌌 Aether Studio Pro (v2.7.2.1) |
| :--- | :--- | :--- | :--- | :--- |
...
> [!NOTE]
> Dieses Projekt wird von einem **einzelnen, unabhängigen Entwickler** mit viel Leidenschaft aufgebaut und weiterentwickelt. Das Projekt befindet sich aktuell in der **Beta-Phase (v2.7.2.1 Beta)**.
> 
