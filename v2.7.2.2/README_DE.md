...
[![Status: Beta](https://img.shields.io/badge/Status-Beta%20v2.7.2.2-yellow.svg)](#-community-feedback--fehler-melden)
...
> [!NOTE]
> Dieses Projekt wird von einem **einzelnen, unabhängigen Entwickler** mit viel Leidenschaft aufgebaut und weiterentwickelt. Das Projekt befindet sich aktuell in der aktiven **Beta-Phase (v2.7.2.2 Beta)**.
> 
...
## 🔄 Was wurde in Version 2.7.2.2 neu hinzugefügt? (Changelog)
