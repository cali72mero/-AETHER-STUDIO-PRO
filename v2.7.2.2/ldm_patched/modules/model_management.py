...
def load_models_gpu(models, memory_required=0):
    ...
    for loaded_model in models_to_load:
        ...
        if lowvram_available and (vram_set_state == VRAMState.LOW_VRAM or vram_set_state == VRAMState.NORMAL_VRAM):
            # Performance Boost: Optimize VRAM allocation headroom for 6GB GPUs (RTX 3050)
            # Instead of overly conservative 1024MB + 30% margin, use 650MB + 15% margin.
            # This keeps up to ~3.8-4.2 GB of weights directly in VRAM rather than constantly swapping across PCIe RAM!
            calc_lowvram_mem = int(max(64 * (1024 * 1024), (current_free_mem - 650 * (1024 * 1024)) / 1.15 ))
